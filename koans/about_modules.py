...
class AboutModules(Koan):
    ...
    def test_a_module_can_limit_wildcard_imports(self):
        ...
        self.assertEqual("Cuddles", lizard.name) #by using __all__, you can override private 

        # SecretDuck? Never heard of her!
        with self.assertRaises(NameError):
            duck = SecretDuck() #Secret Duck is not included in the __all__ list
