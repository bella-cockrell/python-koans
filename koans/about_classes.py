...
class AboutClasses(Koan):
    ...
    def test_args_must_match_init(self):
        ...
        # THINK ABOUT IT:
        # Why is this so?
        # Maybe because the class must be initialised with a certain property -- but why is it a TypeError?
    ...
    def test_all_objects_support_str_and_repr(self):
        ...
        self.assertEqual("'STRING'", repr("STRING")) #repr prints with quote marks
