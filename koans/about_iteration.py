...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # Reduce takes 2 arguments with one overload. It first takes a method and the iterable object. 
        # It then iterates over each item in the iterable and reduces it to a single value. 
        # The overload is the initialiser. e.g. 1 x 2 x 3 x 4 = 24 
        # but 24 x 2 x 3 x 4 = 576
    ...
    def test_use_pass_for_iterations_with_no_body(self):
        ...
        self.assertEqual(4, num) #returns last number in range
