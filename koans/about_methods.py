...
class AboutMethods(Koan):
    ...
    def test_functions_without_self_arg_are_global_functions(self):
        ...
        self.assertEqual(12, function_with_the_same_name(3,4)) #this is because we're not calling self.function_with_same_name

    def test_calling_methods_in_same_class_with_explicit_receiver(self):
        def function_with_the_same_name(a, b):
            return a * b

        self.assertEqual(7, self.function_with_the_same_name(3,4)) #here, we called self.__
    ...
    def another_method_with_the_same_name(self): #this overwrites previous method
        return 42
    ...
    def empty_method(self): #why would you use this?
        pass
