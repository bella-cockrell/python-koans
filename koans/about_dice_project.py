...
class DiceSet:
    ...
    def roll(self, n):
        #amend this
        self._values = [] #here, the private method is set to an array
        for num in range(1, n + 1):
            self.values.append(random.randint(1, 6)) #the class property is called here instead -- this way the class does not hold state
